...
* общие функции:
	...
	* `.?(index: any, container: list<any>|hash<any, any>|pack<any>, default: any): any` &mdash; функция аналогична функции `.`, за исключением обработки случаев выхода индекса за границы списка и отсутствия ключа в хеш-таблице; в этих случаях функция возвращает `default`;
